    ...
    const steps = [
        {
            ...
            number: "01",
            title: "AI Audit & Scan",
            desc: "Dofollo crawls your entire site map, understanding the semantic relationship between every single page."
        },
        {
            icon: Sparkles,
            number: "02",
            title: "Smart Suggestions",
            desc: "Our engine identifies high-relevance anchor text opportunities that feel natural, not robotic."
        },
        {
            icon: Link,
            number: "03",
            title: "Auto-Insertion",
            desc: "Approve suggestions in bulk. Links are injected directly into your CMS without opening a single editor."
        }
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-4xl lg:text-5xl font-extrabold text-[#0A2E22] mb-6 leading-tight tracking-tight">
                            From Audit to Optimized <br />in <span className="text-[#045C4E]">3 Simple Steps.</span>
                        </h2>
                        <p className="text-lg text-[#0A2E22]/70 mb-12 max-w-lg leading-relaxed">
                            Stop playing guessing games with spreadsheets. Let AI handle the heavy lifting while you focus on creating great content.
                        </p>
                            ...
                            {steps.map((item, i) => (
                                <div key={i} className="relative pl-24 pb-16 last:pb-0 group">
                                    ...
                                    <div className="absolute left-0 top-0 w-[70px] h-[70px] bg-white border border-[#0A2E22]/10 rounded-2xl flex items-center justify-center shadow-[0_5px_15px_-5px_rgba(0,0,0,0.05)] group-hover:scale-105 group-hover:bg-[#0A2E22] group-hover:border-[#0A2E22] transition-all duration-300 z-10">
                                        <item.icon className="w-8 h-8 text-[#045C4E] group-hover:text-[#E1F28F] transition-colors duration-300" />
                                        {/* Number Badge */}
                    ...
                    <div className="relative lg:pl-10">
                        {/* Background Blob */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] bg-[#F5FFEF] rounded-full blur-[80px] -z-10 mix-blend-multiply" />
                        ...
                        <div className="bg-white rounded-[2rem] shadow-[0_40px_80px_-20px_rgba(10,46,34,0.15)] border border-[#0A2E22]/5 overflow-hidden transform hover:scale-[1.01] transition-transform duration-500">
                            ...
                            <div className="bg-[#0A2E22] p-4 flex items-center justify-between">
                                ...
                                <div className="text-[#f5ffef]/60 text-xs font-mono">dofollo_agent_v2.exe</div>
                            </div>
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="flex gap-4 items-start">
                                    <div className="mt-1 w-10 h-10 rounded-xl bg-[#f5ffef] flex items-center justify-center border border-[#0A2E22]/5 shrink-0">
                                        <Scan className="w-5 h-5 text-[#045C4E]" />
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex justify-between items-center mb-2">
                                            <h4 className="font-bold text-[#0A2E22] text-sm">Site Audit</h4>
                                            <span className="text-xs font-bold text-[#045C4E] bg-[#f5ffef] px-2 py-0.5 rounded">Complete</span>
                                        </div>
                                        <div className="w-full bg-[#0A2E22]/5 rounded-full h-2 mb-2">
                                            <div className="w-full h-full bg-[#045C4E] rounded-full" />
                                        </div>
                                        <p className="text-xs text-[#0A2E22]/50">Checked 1,240 pages in 45s</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-center mb-2">
                                            <h4 className="font-bold text-[#0A2E22] text-sm">Opportunities</h4>
                                            <span className="text-xs font-bold text-white bg-[#0A2E22] px-2 py-0.5 rounded animate-pulse">Processing</span>
                                        </div>

                                        {/* Mock Item Cards */}
                                        <div className="space-y-2">
                                            <div className="p-3 bg-[#f5ffef]/50 border border-[#0A2E22]/5 rounded-lg flex items-center justify-between">
                                                <div className="text-xs text-[#0A2E22]/70">
                                                    <span className="font-bold text-[#045C4E]">keyword:</span> "internal linking tools"
                                                </div>
                                            ...
                                            <div className="p-3 bg-white border border-[#0A2E22]/5 rounded-lg flex items-center justify-between shadow-sm">
                                                <div className="text-xs text-[#0A2E22]/70">
                                                    <span className="font-bold text-[#045C4E]">keyword:</span> "SEO automation"
                                                </div>
                                ...
                                <div className="flex gap-4 items-center">
                                    ...
                                    <div className="flex-1 p-4 bg-[#0A2E22] rounded-xl text-white flex justify-between items-center shadow-xl">
                                        <div>
                                            <div className="text-sm font-bold">Auto-Publish</div>
                                            <div className="text-xs text-white/50">215 links queued</div>
                                        </div>
