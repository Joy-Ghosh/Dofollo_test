...
export default function CompetitorAnalysis() {
    ...
    return (
        <section className="py-24 bg-[#0A2E22] text-white relative overflow-hidden bg-noise">
            <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[500px] h-[500px] bg-[#E1F28F]/10 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="container mx-auto relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-2 lg:order-1 relative group" ref={ref}>
                        <div className="absolute inset-0 bg-[#E1F28F]/5 blur-[60px] rounded-full group-hover:bg-[#E1F28F]/10 transition-all duration-500"></div>

                        <div className="w-full bg-[#0D261F] rounded-2xl border border-white/10 shadow-2xl flex flex-col relative overflow-hidden p-6 hover:border-[#E1F28F]/30 transition-colors duration-500">
                            <div className="flex items-center justify-between mb-8">
                                <h3 className="text-white font-bold flex items-center gap-2">
                                    <div className="w-2 h-2 rounded-full bg-[#E1F28F] animate-pulse" />
                                    {competitor_analysis.visual_title}
                                </h3>
                                <div className="text-xs font-mono text-[#0A2E22] bg-[#E1F28F] px-3 py-1 rounded-full font-bold">
                            ...
                            <div className="space-y-4 font-mono text-sm">
                                ...
                                <div
                                    className={`p-4 rounded-xl bg-[#0A2E22] border border-[#E1F28F]/20 mt-6 shadow-lg transition-all duration-700 ${inView ? 'scale-105 shadow-[0_0_30px_-5px_rgba(225,242,143,0.3)]' : 'scale-100'}`}
                                >
                                    <div className="flex justify-between items-center mb-3">
                                        <div className="flex items-center gap-3">
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <h2 className="text-3xl lg:text-5xl font-extrabold mb-6 leading-tight text-white">
                            {competitor_analysis.heading_first} <br /><span className="text-[#E1F28F]">{competitor_analysis.heading_highlight}</span>
                        </h2>
                        <p className="text-lg text-white/60 mb-8 leading-relaxed">
                            {competitor_analysis.description}
                        </p>
                        <a href="https://dash.dofollo.ai/" target="_blank" rel="noopener noreferrer" className="group relative inline-flex items-center gap-2 text-[#E1F28F] font-bold pb-1 overflow-hidden">
                            <span className="relative z-10 transition-colors group-hover:text-white">{competitor_analysis.cta}</span>
                            <span className="absolute bottom-0 left-0 h-[2px] bg-[#E1F28F] transition-all duration-300 group-hover:w-full group-hover:bg-white" style={{ width: '100%' }}></span>
                        </a>
                    </div>
                </div>
            </div>
