                    ...
                    {problem_section.problems.map((item, i) => {
                        ...
                        return (
                            <ScrollReveal
                                ...
                                variant="fade-up"
                                delay={i * 0.1}
                                className="p-8 bg-white rounded-2xl border border-[#0A2E22]/10 shadow-[0_2px_10px_-5px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_30px_-10px_rgba(10,46,34,0.1)] transition-all duration-300 group hover:-translate-y-1"
                            >
