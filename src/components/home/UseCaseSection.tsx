...
export default function UseCaseSection() {
    return (
        <section className="py-24 bg-[#0A2E22] text-[#f5ffef] bg-noise relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <h2 className="text-3xl lg:text-5xl font-extrabold text-center mb-16 tracking-tight text-[#f5ffef]">
                    Built For Every <span className="text-[#E1F28F]">SEO Need</span>
                </h2>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    <div className="p-10 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 text-white shadow-xl hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden group">
                    ...
                    <div className="p-10 rounded-3xl bg-white text-[#0A2E22] shadow-xl hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden group border border-transparent hover:border-[#045C4E]/30">
