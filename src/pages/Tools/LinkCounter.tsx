...
import toolData from '../../data/tools/link-counter.json';

export default function LinkCounter() {
    const { hero, tabs, input_section, analysis_cards, about_section, benefits, improve_section, faq_section, sidebar } = toolData;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-16">
                        ...
                        <div className="bg-white rounded-3xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.08)] border border-[#0A2E22]/10 ring-1 ring-black/5 overflow-hidden relative group/container isolate">
                            ...
                            {/* Header Structure - Distinct Separation */}
                            <div className="relative z-10 p-2 sm:p-3 bg-[#FAFAFA] border-b border-[#0A2E22]/5">
                                <div className="flex p-1 bg-[#E8EAE9] rounded-2xl relative shadow-inner">
                                    {/* Active Tab Elevation - Sharper & Deeper */}
                                    <div className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.04)] ring-1 ring-black/5 transition-all duration-300 ease-[cubic-bezier(0.2,0,0,1)] ${activeTab === 'url' ? 'left-1' : 'left-[calc(50%+2px)]'}`} />

                                    <button
                                        onClick={() => setActiveTab('url')}
                                        className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all duration-300 relative z-10 flex items-center justify-center gap-2.5 tracking-tight ${activeTab === 'url'
                                            ? "text-[#0A2E22]"
                                            : "text-[#0A2E22]/50 hover:text-[#0A2E22]/70"
                                            }`}
                                    >
                                        <Globe className={`w-4 h-4 transition-colors duration-300 ${activeTab === 'url' ? 'text-[#045C4E]' : 'opacity-40'}`} />
                                        {tabs.url_label}
                                    </button>
                                    <button
                                        onClick={() => setActiveTab('compare')}
                                        className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all duration-300 relative z-10 flex items-center justify-center gap-2.5 tracking-tight ${activeTab === 'compare'
                                            ? "text-[#0A2E22]"
                                            : "text-[#0A2E22]/50 hover:text-[#0A2E22]/70"
                                            }`}
                                    >
                                        <LinkIcon className={`w-4 h-4 transition-colors duration-300 ${activeTab === 'compare' ? 'text-[#045C4E]' : 'opacity-40'}`} />
                                        {tabs.compare_label}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="p-8 md:p-12 relative z-10 bg-white">
                                <form onSubmit={handleAnalyze} className="space-y-10">
                                    {activeTab === 'url' ? (
                                        <div className="space-y-6 animate-fade-in-up [animation-fill-mode:both]">
                                            <div className="flex items-center justify-between px-1">
                                                <label className="text-xs font-extrabold text-[#0A2E22]/90 uppercase tracking-widest">{input_section.url_mode.label}</label>
                                            </div>
                                                ...
                                                <div className="relative transition-all duration-200 transform rounded-2xl bg-white shadow-sm border border-[#0A2E22]/10 group-hover:border-[#0A2E22]/20 group-focus-within:border-[#045C4E] group-focus-within:ring-4 group-focus-within:ring-[#045C4E]/10 group-focus-within:-translate-y-0.5 group-focus-within:shadow-[0_10px_30px_-5px_rgba(0,0,0,0.05)]">
                                                    <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                                                        <div className="pr-4 border-r border-[#0A2E22]/10 py-1">
                                                            <Search className="h-5 w-5 text-[#0A2E22]/40 group-focus-within:text-[#045C4E] transition-colors duration-200" />
                                                        </div>
                                                    </div>
                                                    <input
                                                        type="url"
                                                        ...
                                                        placeholder={input_section.url_mode.placeholder}
                                            ...
                                            <div className="flex items-center justify-between px-1.5 pt-2">
                                                <p className="text-xs font-semibold text-[#0A2E22]/50 flex items-center gap-1.5">
                                                    <Shield className="w-3.5 h-3.5 text-[#045C4E]" /> {input_section.url_mode.security_note}
                                                </p>

                                            </div>
                                        </div>
                                    ) : (
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative animate-fade-in-up [animation-fill-mode:both]">
                                            {/* VS Badge - Structural Center */}
                                            <div className="hidden md:flex absolute top-[64px] left-1/2 -translate-x-1/2 w-10 h-10 rounded-xl bg-white border border-[#0A2E22]/10 z-20 items-center justify-center text-[#0A2E22]/40 shadow-[0_5px_15px_-5px_rgba(0,0,0,0.1)] font-black text-[10px] tracking-wide ring-4 ring-white">
                                                {input_section.compare_mode.vs_badge}
                                            </div>

                                            <div className="space-y-4">
                                                <label className="text-xs font-extrabold text-[#0A2E22]/80 uppercase tracking-widest ml-1">{input_section.compare_mode.url_1_label}</label>
                                                <div className="relative group">
                                                    <div className="relative transition-all duration-200 transform rounded-2xl bg-white shadow-sm border border-[#0A2E22]/10 group-hover:border-[#0A2E22]/20 group-focus-within:border-[#045C4E] group-focus-within:ring-4 group-focus-within:ring-[#045C4E]/10 group-focus-within:-translate-y-0.5 group-focus-within:shadow-md">
                                                        <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                                                            <Globe className="h-5 w-5 text-[#0A2E22]/30 group-focus-within:text-[#045C4E] transition-colors" />
                                                        </div>
                                                        <input
                                                            type="url"
                                                            value={compareUrl1}
                                                            onChange={(e) => setCompareUrl1(e.target.value)}
                                                            placeholder={input_section.compare_mode.url_1_placeholder}
                                                            className="block w-full pl-14 pr-4 h-[4.5rem] bg-transparent rounded-2xl text-lg font-medium text-[#0A2E22] placeholder-[#0A2E22]/30 focus:outline-none transition-all"
                                                            required
                                                        />
                                                    </div>
                                                </div>
                                            ...
                                            <div className="space-y-4">
                                                <label className="text-xs font-extrabold text-[#0A2E22]/80 uppercase tracking-widest ml-1">{input_section.compare_mode.url_2_label}</label>
                                                <div className="relative group">
                                                    <div className="relative transition-all duration-200 transform rounded-2xl bg-white shadow-sm border border-[#0A2E22]/10 group-hover:border-[#0A2E22]/20 group-focus-within:border-[#045C4E] group-focus-within:ring-4 group-focus-within:ring-[#045C4E]/10 group-focus-within:-translate-y-0.5 group-focus-within:shadow-md">
                                                        <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                                                            <Globe className="h-5 w-5 text-[#0A2E22]/30 group-focus-within:text-[#045C4E] transition-colors" />
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder={input_section.compare_mode.url_2_placeholder}
                                                            className="block w-full pl-14 pr-4 h-[4.5rem] bg-transparent rounded-2xl text-lg font-medium text-[#0A2E22] placeholder-[#0A2E22]/30 focus:outline-none transition-all"
                                                            required
                                                        />
                                                    </div>
                                    ...
                                    {/* Structural Divider */}
                                    {/* <div className="h-px w-full bg-[#0A2E22]/5 my-8" /> */}
                                    ...
                                    <div className="flex flex-col md:flex-row items-center gap-6 pt-2 animate-fade-in-up [animation-delay:150ms] [animation-fill-mode:both]">
                                        ...
                                        >
                                            ...
                                            {analyzing ? (
                                                <span className="relative z-10 flex items-center gap-2">{input_section.processing_label}<span className="animate-pulse">...</span></span>
                                            ) : (
                                                <span className="relative z-10 flex items-center gap-2">
                                                    {activeTab === 'compare' ? input_section.compare_mode.button_label : input_section.url_mode.button_label}
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {analysis_cards.cards.map((card, index) => {
                                    ...
                                    return (
                                        <div key={index} className="p-8 bg-white rounded-3xl border border-[#0A2E22]/5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
                                            ...
                                            <div className={`flex items-center gap-2 mb-4 ${textColor} font-bold text-xs uppercase tracking-widest ${badgeBg} inline-block px-2 py-1 rounded`}>
                                                <Icon className="w-3 h-3" /> {card.badge}
                                            </div>
                    ...
                    {/* Right Column: Sidebar & Sticky Promo (Compacted for Visibility) */}
                        ...
                        <div className="bg-white rounded-3xl p-6 border border-[#0A2E22]/5 shadow-sm">
                            ...
                            <div className="space-y-3">
                                {sidebar.recommended_tools.items.map((tool, i) => (
                                    <Link key={i} to={tool.link} className="flex items-center gap-3.5 p-3.5 bg-[#F8FAFC] rounded-2xl border border-[#0A2E22]/5 hover:border-[#045C4E]/20 hover:shadow-md hover:-translate-y-0.5 transition-all group">
                                        <div className="w-9 h-9 rounded-xl bg-white flex items-center justify-center text-[#0A2E22]/60 group-hover:bg-[#045C4E] group-hover:text-[#E1F28F] transition-all">
                                            ...
                                            {tool.icon === "BarChart3" && <BarChart3 className="w-4 h-4" />}
